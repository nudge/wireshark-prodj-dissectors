...
pdj_status_f.flags_unk2 = ProtoField.uint8("pdj_status.flags.unk2", "Unknown 2", base.DEC, nil, 0x80)
...
pdj_status_f.flags_unk1 = ProtoField.uint8("pdj_status.flags.unk1", "Unknown 1", base.DEC, nil, 0x04)
pdj_status_f.flags_bpm = ProtoField.uint8("pdj_status.flags.bpm", "BPM", base.DEC, nil, 0x02)
pdj_status_f.flags_unk0 = ProtoField.uint8("pdj_status.flags.unk0", "Unknown 0", base.DEC, nil, 0x01)
...
function p_pdj_status.dissector (buf, pkt, root)
  ...
  if packet_type == 0x0a then
    ...
    subtree_flags:add(pdj_status_f.flags_unk2, flags_ptr)
    ...
    subtree_flags:add(pdj_status_f.flags_unk1, flags_ptr)
